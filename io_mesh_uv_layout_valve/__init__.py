...
bl_info = {
    "name": "UV Layout (Valve-like)",
    "author": "Campbell Barton, Matt Ebb (Forked by Gordon Freakman)",
    "version": (1, 2, 0),
    "blender": (3, 0, 0),
    "location": "UV Editor > UV > Export UV Layout (Half-Life)",
    "description": "Export the UV layout as a 2D graphic (but aliased)",
    "warning": "",
...
class ExportUVLayout(bpy.types.Operator):
    """Export UV layout to file (Half-Life)"""

    bl_idname = "uv.export_layout_hl2"
    bl_label = "Export UV Layout (Half-Life)"
    ...
    def invoke(self, context, event):
        ...
        self.filepath = self.get_default_file_name(context) + ".png"
